<div>
    ...
    <section class="lg:mt-10 mt-4">
        ...
        <div class="flex flex-wrap lg:space-x-5 space-x-2">
            ...
            <p class="lg:text-xl text-sm my-4 lg:w-[10%] w-fit rounded-full lg:p-2 px-3 py-1  shadow-lg text-center bg-gray-50">{{ $item->name }}</p>
        @empty
    ...
    <div class="my-4">
        <div class="brand-bg w-full lg:w-[40%] rounded-md text-center text-white py-2">Book Now</div>
    </div>
</div>
